<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="{{ asset('img/backend/brand/logo_long.png') }}" width="135" height="50" alt="CoreUI Logo">
        <img class="navbar-brand-minimized" src="{{ asset('img/backend/brand/logo.png') }}" width="50" height="50" alt="CoreUI Logo">
    </a>
